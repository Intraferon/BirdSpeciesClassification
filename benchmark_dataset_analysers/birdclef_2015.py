...
class BirdCLEF2015(Dataset):
    ...
    def __init__(self):
        ...
        # Parent Constructor
        super(BirdCLEF2015, self).__init__(dataset_path)
    ...
    def statisticise(self, audio_type, partition):
        ...
        self.update_statistics(summary_statistics, "summary", modality="audio", rendition="birdclef_2015", audio_type=audio_type, partition=partition)
        self.update_statistics(distribution_statistics, "distribution", modality="audio", rendition="birdclef_2015", audio_type=audio_type, partition=partition)
    ...
    def statisticise_monophone_train(self):
        ...
        for instance_file_name in os.listdir(data_path):
            ...
            if rendition == "LIFECLEF2014" or rendition == "LIFECLEF2015":
