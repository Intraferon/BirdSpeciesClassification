...
class BirdCLEF2020(Dataset):
    ...
    def __init__(self):
        ...
        # Paths
        dataset_path = "D:/Masters/Resources/Benchmark Datasets/BirdCLEF 2020"

        # Parent Constructor
        super(BirdCLEF2020, self).__init__(dataset_path)
    ...
    def statisticise_time_annotated_soundscape_validation(self):
        ...
        metadata_path = f"{self.downloaded_files_path}/soundscape_validation/metadata/gt/"
        soundscape_count = 0
