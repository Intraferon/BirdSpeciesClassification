...
class INaturalist2017(Dataset):
    ...
    def __init__(self):
        ...
        # Paths
        dataset_path = "D:/Masters/Resources/Benchmark Datasets/iNaturalist 2017"

        # Parent Constructor
        super(INaturalist2017, self).__init__(dataset_path)
    ...
    def statisticise(self, partition):
        ...
        if partition == "train" or partition == "validation":
            ...
            instance_file_name = "train2017.json" if partition == "train" else "val2017.json"
            ...
            for instance_data in instance_data_list:
                instance_path = instance_data["file_name"]
                instance_parent_class = instance_path.split("/")[-3]
        ...
        if partition == "test":
            summary_statistics["instance_count"] = 182707
            summary_statistics["species_count"] = 5089
            summary_statistics["alternate_class_count"] = 964
